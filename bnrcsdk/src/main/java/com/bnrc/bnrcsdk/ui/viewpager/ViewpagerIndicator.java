...
//配置属性 START-------------------------------------------------------------------------------------
    ...
    private int indicatorColor = Color.parseColor("#35ACD4");
     ...
     * tab
     */
    private int tabTextSize = 12;//tab字号,dp
    private int tabTextColor = Color.parseColor("#b4b4b4");//tab字色
     ...
     * 被选中的tab
     */
    private int selectedTabTextSize = 12;//dp
    private int selectedTabTextColor = Color.parseColor("#ff35ACD4");
